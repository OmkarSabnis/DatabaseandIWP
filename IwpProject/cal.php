...
<body>
    ...
    $query=mysqli_query($connect, "SELECT * from enrolls where Student_ID = '$username' ");
    ...
    while($result=mysqli_fetch_array($query)){
        ...
        echo '<tr>
              ...
              <td> <button id="button" value="no" onclick="loadcourse(\''.$username.'\',\''.$Course_ID.'\',\''.$Course_Name.'\',\''.$Course_Credit.'\',\''.$Course_Slot.'\',\''.$Course_Type.'\')">Process</button></td>
              </tr>';
        }
        $i+=1;
      }
