...
$query=mysqli_query($connect, "UPDATE reviews set TeacherComment = '".$comment."' where Student_ID = '".$studentid."' and Course_ID = '".$courseid."' and Assignment = '". $review."';") or die(mysqli_error());
